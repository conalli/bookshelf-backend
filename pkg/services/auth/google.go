...
func (s *service) googleOIDCRedirect(ctx context.Context, authType, code string, cookies []*http.Cookie) (string, errors.APIErr) {
	...
	default:
		...
		return "", errors.NewBadRequestError("invalid auth type in request")
	}
	return APIKey, nil
}

func (s *service) googleOIDCLogIn(ctx context.Context, email string) (string, errors.APIErr) {
...
func (s *service) googleOIDCSignUp(ctx context.Context, claims GoogleIDTokenClaims) (string, errors.APIErr) {
